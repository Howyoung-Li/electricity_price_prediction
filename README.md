...
- 最优模型 MAE 约 19 EUR/MWh，相比 lag-24h naive baseline 降低约 30%，说明模型有效；但从生产级交易预测角度看仍有明显提升空间，主要受限于 2023 年价格 regime shift、缺少燃料/碳价/跨区交易/机组可用容量等市场关键变量，以及 ERA5 reanalysis 与真实日前预测信息时点不一致。
